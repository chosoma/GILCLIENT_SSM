...
//                            CollectService.cacelWarnTempPeriodTimer(unitType, unitId);//default
                            CollectService.cacelWarnTempPeriodTimer2(unitType, unitId);//2018/6/12
            ...
            LogServer.logError(CollectSocket.class, e);
    ...
    private synchronized void sendMSG(byte[] msg) throws IOException {
        ...
        try {
            out.write(msg);
            out.flush();
            debugShow.send(msg, msg.length, String.valueOf(index));
...
//        System.out.println(netBean.getChannel());
        if (netBean != null) {
