...
public class SensorService {
	...
	public static final String Sensor_SF6 = "六氟化硫";
	public static final String Sensor_WD = "温升";
	...
	public static final String[] Sensor_Type = new String[] { Sensor_SF6, Sensor_WD, Sensor_SSJ, Sensor_HITCH };
	...
	public static DataManageModel getDataModel(String type) {
		...
		case Sensor_HITCH:
			return DataModel_Hitch.getInstance();
		default:
			return null;
		}
	}
