...
public class MyFileChooserUI extends BasicFileChooserUI {
	...
	private FileView fileView = new MyFileView();
	...
	private class MyFileChooserUIAccessor implements
			FilePane.FileChooserUIAccessor {
		public JFileChooser getFileChooser() {
			return MyFileChooserUI.this.getFileChooser();
		}

		public BasicDirectoryModel getModel() {
			return MyFileChooserUI.this.getModel();
		}

		public JPanel createList() {
			return MyFileChooserUI.this.createList(getFileChooser());
		}

		public JPanel createDetailsView() {
			return MyFileChooserUI.this.createDetailsView(getFileChooser());
		}

		public boolean isDirectorySelected() {
			return MyFileChooserUI.this.isDirectorySelected();
		}

		public File getDirectory() {
			return MyFileChooserUI.this.getDirectory();
		}

		public Action getChangeToParentDirectoryAction() {
			return MyFileChooserUI.this.getChangeToParentDirectoryAction();
		}

		public Action getApproveSelectionAction() {
			return MyFileChooserUI.this.getApproveSelectionAction();
		}

		public Action getNewFolderAction() {
			return MyFileChooserUI.this.getNewFolderAction();
		}

		public MouseListener createDoubleClickListener(JList list) {
			return MyFileChooserUI.this.createDoubleClickListener(
					getFileChooser(), list);
		}

		public ListSelectionListener createListSelectionListener() {
			return MyFileChooserUI.this
	...
	public void installComponents(JFileChooser fc) {
		filePane = new FilePane(new MyFileChooserUIAccessor());
		...
		filenameTextField.setBorder(MyUtil.Component_Border);
	...
	protected void installStrings(JFileChooser fc) {
		...
		folderNameLabelMnemonic = UIManager
				.getInt("FileChooser.folderNameLabelMnemonic");
	...
	protected class DirectoryComboBoxModel extends AbstractListModel implements
		...
		private void addItem(File directory) {
			...
			File[] baseFolders;
			if (useShellFolder) {
				baseFolders = AccessController
						.doPrivileged(new PrivilegedAction<File[]>() {
							public File[] run() {
								return (File[]) ShellFolder
	...
	// * FileView operations *
	// ***********************
	protected class MyFileView extends BasicFileView {
